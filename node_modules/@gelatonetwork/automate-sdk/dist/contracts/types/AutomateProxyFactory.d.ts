...
export interface AutomateProxyFactoryInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "deploy" | "deployFor" | "determineProxyAddress" | "getNextSeed" | "getOwnerOf" | "getProxyOf" | "implementation" | "isProxy" | "ops" | "version"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "determineProxyAddress", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "determineProxyAddress", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "getNextSeed", data: BytesLike): Result;
...
export interface AutomateProxyFactory extends BaseContract {
    ...
    functions: {
        ...
        deployFor(owner: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        determineProxyAddress(_account: string, overrides?: CallOverrides): Promise<[string]>;
        ...
        getProxyOf(_account: string, overrides?: CallOverrides): Promise<[string, boolean]>;
    ...
    filters: {
        "DeployProxy(address,address,bytes32,bytes32,address)"(deployer?: string | null, owner?: string | null, seed?: null, salt?: null, proxy?: null): DeployProxyEventFilter;
        DeployProxy(deployer?: string | null, owner?: string | null, seed?: null, salt?: null, proxy?: null): DeployProxyEventFilter;
    };
    estimateGas: {
        deploy(overrides?: Overrides & {
            from?: string;
        ...
        determineProxyAddress(_account: string, overrides?: CallOverrides): Promise<BigNumber>;
        getNextSeed(_account: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        determineProxyAddress(_account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getNextSeed(_account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getOwnerOf(_proxy: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getProxyOf(_account: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        implementation(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        isProxy(proxy: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
